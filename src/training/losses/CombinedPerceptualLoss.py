...
class VGGPerceptualLoss(nn.Module):
    def __init__(
        self, layers=[0, 5, 10, 19, 28], weights=[1.0] * 5, apply_gamma_curve=False
    ):
        super().__init__()
...
class CombinedPerceptualLoss(nn.Module):
    def __init__(self, **lambdas):
        ...
        self.loss_modules = {
            ...
            "ssim_fine": lambda p, t: 1
            - ms_ssim(p, t, data_range=1.0, size_average=True, weights=[1, 0, 0, 0, 0]),
