...
CONFIG = {
    "model_name": "DemoNAFNet_noraf_cont_Gram_1",
    ...
    "RUN_ID": "98e3b0b4e90c4db3b7743cd206abfa1c",
    "lumi_noise": 0,
    "crop_size": 256,
    "residual_mask": False,
    'SWL_scale': 0.1,
    "n_direction_scale": 0.25,
    "iso_range": [0, 1e9],
    "added_noise": 0.,
    "no_raf": True,
    "iter_per_iter": 1,
...
def train():
    ...
    criterion = nn.L1Loss()
    # criterion = CCMLoss()
    texture_criteria = SlicingLoss(1, n_direction_scale=CONFIG['n_direction_scale']).to(CONFIG['device'])
